 ...
 * @author renan
 */
public class JFHard8 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFHard8(String nome, int pontuacao, String dificuldade){
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFHard9 next = new JFHard9(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta1.setText("Sudeste e Sul");
        ...
        JBResposta2.setText("Nordeste e Sul");
        ...
        JBResposta3.setText("Nordeste e Sudeste");
        ...
        lblEnunciado1.setText("No Brasil, as regiões que");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFHard8.ICONIFIED);
