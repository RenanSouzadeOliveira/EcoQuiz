 ...
 * @author renan
 */
public class JFHard7 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFHard7(String nome, int pontuacao, String dificuldade){
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFHard8 next = new JFHard8(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta1.setText("Rotação de culturas");
        ...
        JBResposta2.setText("Adubação orgânica");
        ...
        JBResposta3.setText("Fertilização química");
        ...
        lblEnunciado1.setText("Existem várias técnicas  nos sistemas de cultivo que permitem");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFHard7.ICONIFIED);
