 ...
 * @author renan
 */
public class JFHard1 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFHard1(String nome, int pontuacao, String dificuldade){
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFHard2 next = new JFHard2(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta1.setText("Efeito estufa");
        ...
        JBResposta2.setText("Chuva ácida");
        ...
        JBResposta3.setText("Eutrofização");
        ...
        lblEnunciado1.setText("O aquecimento global é consequência da intensificação");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFHard1.ICONIFIED);
