 ...
 * @author renan
 */
public class JFHard4 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFHard4(String nome, int pontuacao, String dificuldade){
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFHard5 next = new JFHard5(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        lblEnunciado.setText("consequências para a comunidade ambiente, exceto:");

        JBResposta0.setBackground(new java.awt.Color(128, 222, 234));
        JBResposta0.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        JBResposta0.setText("Aumento do processo de erosão dos solos");
        ...
        JBResposta1.setText("Modificações climáticas");
        ...
        JBResposta2.setText("Provocar a desertificação");
        ...
        JBResposta3.setText("Diminuição do processo de erosão dos solos");
        ...
        lblEnunciado1.setText("O desmatamento pode trazer diversas");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFHard4.ICONIFIED);
