 ...
 * @author renan
 */
public class JFHard5 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFHard5(String nome, int pontuacao, String dificuldade){
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFHard6 next = new JFHard6(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta0.setText("Morte dos micro-organismos");
        ...
        JBResposta1.setText("Aumento da poluição atmosférica");
        ...
        JBResposta2.setText("Diminuição dos nutrientes do solo");
        ...
        JBResposta3.setText("Redução do aquecimento global");
        ...
        lblEnunciado1.setText("As queimadas podem trazer diversas");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFHard5.ICONIFIED);
