 ...
 * @author renan
 */
public class JFNormal1 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFNormal1(String nome, int pontuacao, String dificuldade) {
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFNormal2 next = new JFNormal2(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta1.setText("Fisiologia");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFNormal1.ICONIFIED);
