 ...
 * @author renan
 */
public class JFNormal5 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFNormal5(String nome, int pontuacao, String dificuldade) {
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFNormal6 next = new JFNormal6(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta1.setText("Espécies consumistas");
        ...
        JBResposta3.setText("Espécies generalistas");
        ...
        JBResposta2.setText("Espécies amplas");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFNormal5.ICONIFIED);
