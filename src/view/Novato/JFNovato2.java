 ...
 * @author renan
 */
public class JFNovato2 extends javax.swing.JFrame {
    String user;
    int pontuacao;
    String dificuldade;
     ...
     */
    public JFNovato2(String nome, int pontuacao,String dificuldade) {
        initComponents();
        ...
        TimerTask task = new TimerTask(){
            ...
            public void run(){
                ...
                if (tempo == 0){
                    JFNovato3 next = new JFNovato3(user,pontuacao,dificuldade);
    ...
    private void initComponents() {
        ...
        JBResposta1.setText("Contaminação das Águas");
        ...
        JBResposta3.setText("Desmatamento");
        ...
        lblEnunciado1.setText("Um dos principais impactos ambientais causados");
    ...
    private void lblMinimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizarMouseClicked
        this.setState(JFNovato2.ICONIFIED);
